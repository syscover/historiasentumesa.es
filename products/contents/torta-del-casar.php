        ...
        <div id="video_product">
            <div class="video_content_product">
                <div class="video_poster_product" style="background-image: url('/img/products/torta-del-casar/video_poster.jpg');">
                    <a href="#" class="play_video_btn" onclick="javascript:trackEvent('send', 'event', 'Botón play vídeo', 'Reproducir', 'Vídeo torta-del-casar');"></a>
                </div>
...
<script>
    var videoId1 = 'iPgG_cjht0A';
    var videoId2 = '9x2jn298k2U';
</script>

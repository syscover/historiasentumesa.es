...
<html>
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/style.css?' . now()->timestamp ) }}"/>
    ...
    <body data-menu="close" data-status="" data-section="welcome">
                    ...
                    <a href="#" id="enter_link" onclick="javascript:trackEvent('send', 'event', 'Botón entrar', 'Acceder', 'Acceder web');">
                        <div class="welcome__first-txt">
                            ...
                            <ul class="welcome__stamps-list list-inline">
                                ...
                                <li class="igp">
                                    <img src="{{ asset('img/sello-indicacion.svg') }}" alt="Indicación de origen protegida"/>
            ...
            <div class="swiper-container slider buscador-productor">
                <div class="swiper-wrapper">
                    @foreach($products as $product)
                        @include('products.headers.' . $product, ['product' => $product])
                    @endforeach
                </div>
            </div>
        ...
        <header id="header" data-0="transform:translate(0px, 0px);" data-180="transform:translate(0px, -80px);">
            ...
            <div class="swiper-container navigation">
                <div class="swiper-wrapper">
                    @foreach($products as $product)
                        <div class="swiper-slide"><div class="dot"></div></div>
                    @endforeach
                </div>
            </div>
        </header>
        ...
        <div class="videos__container" style="display: none;">
            ...
            <div class="row videos">
                ...
                <div class="col s12 m6 l8">
                    <a href="#" class="bt-video_lista" data-video="zoZNf0XXOJg"><div class="play_video_btn_lista"></div><img class="video-grande" src="{{ asset('img/video_poster_desktop.jpg') }}" width="100%" height="auto" /><br><p class="nombre">HISTORIAS EN TU MESA</p></a>
                </div>
            </div>

            <div class="row videos intro">
                <div class="col s12 m4">
                    <a href="" class="bt-video_lista" data-video="BPrkoNG1uXQ">
                        <div class="play_video_btn_lista"></div>
                        <img src="{{ asset('img/products/intro1_maxresdefault.jpg') }}" width="100%" height="auto" /><br>
                        <p class="nombre">El valor de ciertos productos</p>
                    </a>
                </div>
                <div class="col s12 m4">
                    <a href="" class="bt-video_lista" data-video="nFHznLE9sLM">
                       <div class="play_video_btn_lista"></div>
                        <img src="{{ asset('img/products/intro2_maxresdefault.jpg') }}" width="100%" height="auto" /><br>
                        <p class="nombre">Amamos nuestro origen</p>
                    </a>
                </div>
            </div>
